# The code will no longer be maintained in this repository due to theano being discontinued. Please refer to CMU-Multimodal Data SDK under mmmodelsdk and related_repos to find the newest implementations for Tensor Fusion Network. 
